...
import (
	...
	externalversions "github.com/kubeflow/kfp-tekton/tekton-catalog/pipeline-loops/pkg/client/informers/externalversions"
	client "github.com/kubeflow/kfp-tekton/tekton-catalog/pipeline-loops/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/kubeflow/kfp-tekton/tekton-catalog/pipeline-loops/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
