...
require (
	...
	github.com/kubeflow/pipelines/kubernetes_platform v0.0.0-20240111221413-aac4408237df // indirect
	...
	knative.dev/hack v0.0.0-20230712131415-ddae80293c43 // indirect
