...
import (
	...
	fake "github.com/kubeflow/kfp-tekton/tekton-catalog/tekton-exithandler/pkg/client/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/kubeflow/kfp-tekton/tekton-catalog/tekton-exithandler/pkg/client/clientset/versioned/fake.Clientset from context.")
	}
