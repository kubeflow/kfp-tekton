...
import (
	v1alpha1 "github.com/kubeflow/kfp-tekton/tekton-catalog/tekton-exithandler/pkg/client/clientset/versioned/typed/exithandler/v1alpha1"
...
func (c *FakeCustomV1alpha1) ExitHandlers(namespace string) v1alpha1.ExitHandlerInterface {
	return &FakeExitHandlers{c, namespace}
}
