...
import (
	...
	filtered "github.com/kubeflow/kfp-tekton/tekton-catalog/tekton-kfptask/pkg/client/injection/informers/factory/filtered"
...
func Get(ctx context.Context, selector string) v1alpha1.KfpTaskInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/kubeflow/kfp-tekton/tekton-catalog/tekton-kfptask/pkg/client/informers/externalversions/kfptask/v1alpha1.KfpTaskInformer with selector %s from context.", selector)
	}
