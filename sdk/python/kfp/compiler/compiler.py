...
from ._op_to_template import _op_to_step_tekton
...
class Compiler(object):
  ...
  def _create_dag_tasks(self, pipeline, op_transformers=None, params=None, op_to_templates_handler=None):
    """Create all groups and ops templates in the pipeline.
    ...
    Args:
      ...
      op_to_templates_handler: Handler which converts a base op into a list of argo templates.
    """
    op_to_steps_handler = op_to_templates_handler or (lambda op : [_op_to_step_tekton(op)])
    root_group = pipeline.groups[0]
  ...
  def _create_pipeline_tekton(self, args, pipeline, op_transformers=None, pipeline_conf=None):
    ...
    # Steps
    steps = self._create_dag_tasks(pipeline, op_transformers, params)          
  ...
  def _create_workflow(self,
    ...
    workflow = self._create_pipeline_tekton(
        args_list_with_defaults,
        dsl_pipeline,
        op_transformers,
        pipeline_conf,
