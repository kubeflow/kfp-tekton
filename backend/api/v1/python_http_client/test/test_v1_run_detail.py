...
from kfp_server_api_v1.models.v1_run_detail import V1RunDetail  # noqa: E501
...
class TestV1RunDetail(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kfp_server_api_v1.models.v1_run_detail.V1RunDetail()  # noqa: E501
        if include_optional :
            return V1RunDetail(
                run = kfp_server_api_v1.models.v1_run.v1Run(
                    id = '0', 
                    name = '0', 
                    ...
                    error = '0', 
                    metrics = [
                        kfp_server_api_v1.models.v1_run_metric.v1RunMetric(
                            name = '0', 
                            node_id = '0', 
                            number_value = 1.337, 
                            format = 'UNSPECIFIED', )
                        ], ), 
                pipeline_runtime = kfp_server_api_v1.models.v1_pipeline_runtime.v1PipelineRuntime(
                    pipeline_manifest = '0', 
                    workflow_manifest = '0', )
            )
        else :
