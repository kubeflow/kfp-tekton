...
from kfp_tekton_server_api.models.v1_list_runs_response import V1ListRunsResponse  # noqa: E501
...
class TestV1ListRunsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kfp_tekton_server_api.models.v1_list_runs_response.V1ListRunsResponse()  # noqa: E501
        if include_optional :
            return V1ListRunsResponse(
                runs = [
                    kfp_tekton_server_api.models.v1_run.v1Run(
                        id = '0', 
                        name = '0', 
