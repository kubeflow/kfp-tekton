...
from kfp_server_api_v1.models.v1_list_pipeline_versions_response import V1ListPipelineVersionsResponse  # noqa: E501
...
class TestV1ListPipelineVersionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kfp_server_api_v1.models.v1_list_pipeline_versions_response.V1ListPipelineVersionsResponse()  # noqa: E501
        if include_optional :
            return V1ListPipelineVersionsResponse(
                versions = [
                    kfp_server_api_v1.models.v1_pipeline_version.v1PipelineVersion(
                        id = '0', 
                        name = '0', 
