...
from kfp_tekton_server_api.api.job_service_api import JobServiceApi  # noqa: E501
...
class TestJobServiceApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kfp_tekton_server_api.api.job_service_api.JobServiceApi()  # noqa: E501
