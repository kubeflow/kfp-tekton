...
from kfp_tekton_server_api.models.v1_list_jobs_response import V1ListJobsResponse  # noqa: E501
...
class TestV1ListJobsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kfp_tekton_server_api.models.v1_list_jobs_response.V1ListJobsResponse()  # noqa: E501
        if include_optional :
            return V1ListJobsResponse(
                jobs = [
                    kfp_tekton_server_api.models.v1_job.v1Job(
                        id = '0', 
                        name = '0', 
                        description = '0', 
