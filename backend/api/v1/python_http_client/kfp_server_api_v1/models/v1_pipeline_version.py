...
class V1PipelineVersion(object):
    ...
    def id(self):
        ...
        :return: The id of this V1PipelineVersion.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this V1PipelineVersion.

        Output. Unique version ID. Generated by API server.  # noqa: E501

        :param id: The id of this V1PipelineVersion.  # noqa: E501
        :type id: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this V1PipelineVersion.  # noqa: E501

        Optional input field. Version name provided by user.  # noqa: E501

        :return: The name of this V1PipelineVersion.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V1PipelineVersion.

        Optional input field. Version name provided by user.  # noqa: E501

        :param name: The name of this V1PipelineVersion.  # noqa: E501
        :type name: str
        """
    ...
    @property
    def parameters(self):
        """Gets the parameters of this V1PipelineVersion.  # noqa: E501

        Output. The input parameters for this pipeline.  # noqa: E501

        :return: The parameters of this V1PipelineVersion.  # noqa: E501
    ...
    def parameters(self, parameters):
        """Sets the parameters of this V1PipelineVersion.

        Output. The input parameters for this pipeline.  # noqa: E501

        :param parameters: The parameters of this V1PipelineVersion.  # noqa: E501
    ...
    def description(self):
        """Gets the description of this V1PipelineVersion.  # noqa: E501

        Input. Optional. Description for the pipeline version.  # noqa: E501

        :return: The description of this V1PipelineVersion.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this V1PipelineVersion.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1PipelineVersion):
            return False
