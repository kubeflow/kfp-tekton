...
class V1Job(object):
    ...
    def pipeline_spec(self):
        """Gets the pipeline_spec of this V1Job.  # noqa: E501


        :return: The pipeline_spec of this V1Job.  # noqa: E501
    ...
    def pipeline_spec(self, pipeline_spec):
        """Sets the pipeline_spec of this V1Job.


        :param pipeline_spec: The pipeline_spec of this V1Job.  # noqa: E501
        :type pipeline_spec: V1PipelineSpec
        """
    ...
    def resource_references(self):
        """Gets the resource_references of this V1Job.  # noqa: E501

        Optional input field. Specify which resource this job belongs to.  # noqa: E501

        :return: The resource_references of this V1Job.  # noqa: E501
    ...
    def resource_references(self, resource_references):
        """Sets the resource_references of this V1Job.

        Optional input field. Specify which resource this job belongs to.  # noqa: E501

        :param resource_references: The resource_references of this V1Job.  # noqa: E501
    ...
    def service_account(self):
        """Gets the service_account of this V1Job.  # noqa: E501

        Optional input field. Specify which Kubernetes service account this job uses.  # noqa: E501

        :return: The service_account of this V1Job.  # noqa: E501
        :rtype: str
        """
    ...
    def service_account(self, service_account):
        """Sets the service_account of this V1Job.

        Optional input field. Specify which Kubernetes service account this job uses.  # noqa: E501

        :param service_account: The service_account of this V1Job.  # noqa: E501
    ...
    def max_concurrency(self):
        """Gets the max_concurrency of this V1Job.  # noqa: E501


        :return: The max_concurrency of this V1Job.  # noqa: E501
        :rtype: str
        """
    ...
    def max_concurrency(self, max_concurrency):
        """Sets the max_concurrency of this V1Job.


        :param max_concurrency: The max_concurrency of this V1Job.  # noqa: E501
    ...
    @property
    def trigger(self):
        """Gets the trigger of this V1Job.  # noqa: E501


        :return: The trigger of this V1Job.  # noqa: E501
        :rtype: V1Trigger
        """
    ...
    def trigger(self, trigger):
        """Sets the trigger of this V1Job.


        :param trigger: The trigger of this V1Job.  # noqa: E501
        :type trigger: V1Trigger
        """
    ...
    @property
    def mode(self):
        """Gets the mode of this V1Job.  # noqa: E501


        :return: The mode of this V1Job.  # noqa: E501
        :rtype: JobMode
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this V1Job.


        :param mode: The mode of this V1Job.  # noqa: E501
        :type mode: JobMode
        """
    ...
    @property
    def error(self):
        """Gets the error of this V1Job.  # noqa: E501
        ...
        :return: The error of this V1Job.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this V1Job.

        In case any error happens retrieving a job field, only job ID and the error message is returned. Client has the flexibility of choosing how to handle error. This is especially useful during listing call.  # noqa: E501

        :param error: The error of this V1Job.  # noqa: E501
        :type error: str
        """
    ...
    @property
    def enabled(self):
        """Gets the enabled of this V1Job.  # noqa: E501

        Input. Whether the job is enabled or not.  # noqa: E501

        :return: The enabled of this V1Job.  # noqa: E501
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this V1Job.

        Input. Whether the job is enabled or not.  # noqa: E501

        :param enabled: The enabled of this V1Job.  # noqa: E501
        :type enabled: bool
        """
    ...
    @property
    def no_catchup(self):
        """Gets the no_catchup of this V1Job.  # noqa: E501
        ...
        :return: The no_catchup of this V1Job.  # noqa: E501
        :rtype: bool
        """
    ...
    def no_catchup(self, no_catchup):
        """Sets the no_catchup of this V1Job.

        Optional input field. Whether the job should catch up if behind schedule. If true, the job will only schedule the latest interval if behind schedule. If false, the job will catch up on each past interval.  # noqa: E501

        :param no_catchup: The no_catchup of this V1Job.  # noqa: E501
