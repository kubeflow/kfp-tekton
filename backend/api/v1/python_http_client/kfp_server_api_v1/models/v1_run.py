...
class V1Run(object):
    ...
    def storage_state(self):
        """Gets the storage_state of this V1Run.  # noqa: E501


        :return: The storage_state of this V1Run.  # noqa: E501
        :rtype: V1RunStorageState
        """
        return self._storage_state

    @storage_state.setter
    def storage_state(self, storage_state):
        """Sets the storage_state of this V1Run.


        :param storage_state: The storage_state of this V1Run.  # noqa: E501
        :type storage_state: V1RunStorageState
        """
    ...
    def pipeline_spec(self):
        """Gets the pipeline_spec of this V1Run.  # noqa: E501


        :return: The pipeline_spec of this V1Run.  # noqa: E501
    ...
    def pipeline_spec(self, pipeline_spec):
        """Sets the pipeline_spec of this V1Run.


        :param pipeline_spec: The pipeline_spec of this V1Run.  # noqa: E501
    ...
    def resource_references(self):
        """Gets the resource_references of this V1Run.  # noqa: E501
        ...
        :return: The resource_references of this V1Run.  # noqa: E501
    ...
    def resource_references(self, resource_references):
        """Sets the resource_references of this V1Run.

        Optional input field. Specify which resource this run belongs to. When creating a run from a particular pipeline version, the pipeline version can be specified here.  # noqa: E501

        :param resource_references: The resource_references of this V1Run.  # noqa: E501
    ...
    def service_account(self):
        """Gets the service_account of this V1Run.  # noqa: E501

        Optional input field. Specify which Kubernetes service account this run uses.  # noqa: E501

        :return: The service_account of this V1Run.  # noqa: E501
        :rtype: str
        """
    ...
    def service_account(self, service_account):
        """Sets the service_account of this V1Run.

        Optional input field. Specify which Kubernetes service account this run uses.  # noqa: E501

        :param service_account: The service_account of this V1Run.  # noqa: E501
    ...
    def scheduled_at(self):
        """Gets the scheduled_at of this V1Run.  # noqa: E501
        ...
        :return: The scheduled_at of this V1Run.  # noqa: E501
        :rtype: datetime
        """
    ...
    def scheduled_at(self, scheduled_at):
        """Sets the scheduled_at of this V1Run.

        Output. When this run is scheduled to run. This could be different from created_at. For example, if a run is from a backfilling job that was supposed to run 2 month ago, the scheduled_at is 2 month ago, v.s. created_at is the current time.  # noqa: E501

        :param scheduled_at: The scheduled_at of this V1Run.  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this V1Run.  # noqa: E501
        ...
        :return: The error of this V1Run.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this V1Run.

        In case any error happens retrieving a run field, only run ID and the error message is returned. Client has the flexibility of choosing how to handle error. This is especially useful during listing call.  # noqa: E501

        :param error: The error of this V1Run.  # noqa: E501
        :type error: str
        """
    ...
    def metrics(self, metrics):
        """Sets the metrics of this V1Run.

        Output. The metrics of the run. The metrics are reported by ReportMetrics API.  # noqa: E501

        :param metrics: The metrics of this V1Run.  # noqa: E501
