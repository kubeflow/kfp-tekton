...
func (o *JobServiceEnableJobOK) Error() string {
	return fmt.Sprintf("[POST /apis/v1/jobs/{id}/enable][%d] jobServiceEnableJobOK  %+v", 200, o.Payload)
}
...
func (o *JobServiceEnableJobDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v1/jobs/{id}/enable][%d] JobService_EnableJob default  %+v", o._statusCode, o.Payload)
}
