...
func (o *JobServiceListJobsOK) Error() string {
	return fmt.Sprintf("[GET /apis/v1/jobs][%d] jobServiceListJobsOK  %+v", 200, o.Payload)
}
...
func (o *JobServiceListJobsOK) GetPayload() *job_model.V1ListJobsResponse {
	return o.Payload
}
...
func (o *JobServiceListJobsDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v1/jobs][%d] JobService_ListJobs default  %+v", o._statusCode, o.Payload)
}
