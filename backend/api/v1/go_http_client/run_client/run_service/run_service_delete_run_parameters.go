...
// WithID adds the id to the run service delete run params
func (o *RunServiceDeleteRunParams) WithID(id string) *RunServiceDeleteRunParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the run service delete run params
func (o *RunServiceDeleteRunParams) SetID(id string) {
	o.ID = id
}
