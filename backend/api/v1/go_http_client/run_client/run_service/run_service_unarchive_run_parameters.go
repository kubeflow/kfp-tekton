...
// WithID adds the id to the run service unarchive run params
func (o *RunServiceUnarchiveRunParams) WithID(id string) *RunServiceUnarchiveRunParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the run service unarchive run params
func (o *RunServiceUnarchiveRunParams) SetID(id string) {
	o.ID = id
}
