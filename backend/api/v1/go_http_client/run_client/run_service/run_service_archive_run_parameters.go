...
// WithID adds the id to the run service archive run params
func (o *RunServiceArchiveRunParams) WithID(id string) *RunServiceArchiveRunParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the run service archive run params
func (o *RunServiceArchiveRunParams) SetID(id string) {
	o.ID = id
}
