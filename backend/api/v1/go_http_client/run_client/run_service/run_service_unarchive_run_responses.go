...
func (o *RunServiceUnarchiveRunOK) Error() string {
	return fmt.Sprintf("[POST /apis/v1/runs/{id}:unarchive][%d] runServiceUnarchiveRunOK  %+v", 200, o.Payload)
}
...
func (o *RunServiceUnarchiveRunDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v1/runs/{id}:unarchive][%d] RunService_UnarchiveRun default  %+v", o._statusCode, o.Payload)
}
