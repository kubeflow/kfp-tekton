...
func (o *RetryRunOK) Error() string {
	return fmt.Sprintf("[POST /apis/v1/runs/{run_id}/retry][%d] retryRunOK  %+v", 200, o.Payload)
}
...
func (o *RetryRunDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v1/runs/{run_id}/retry][%d] RetryRun default  %+v", o._statusCode, o.Payload)
}
