...
type ReportRunMetricsParams struct {
	...
	/*Body*/
	Body *run_model.V1ReportRunMetricsRequest
	/*RunID
...
func (o *ReportRunMetricsParams) WithBody(body *run_model.V1ReportRunMetricsRequest) *ReportRunMetricsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the report run metrics params
func (o *ReportRunMetricsParams) SetBody(body *run_model.V1ReportRunMetricsRequest) {
	o.Body = body
}
