...
func (o *ReportRunMetricsOK) Error() string {
	return fmt.Sprintf("[POST /apis/v1/runs/{run_id}:reportMetrics][%d] reportRunMetricsOK  %+v", 200, o.Payload)
}
...
func (o *ReportRunMetricsDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v1/runs/{run_id}:reportMetrics][%d] ReportRunMetrics default  %+v", o._statusCode, o.Payload)
}
