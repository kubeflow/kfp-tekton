...
type ReadArtifactOK struct {
	Payload *run_model.V1ReadArtifactResponse
}

func (o *ReadArtifactOK) Error() string {
	return fmt.Sprintf("[GET /apis/v1/runs/{run_id}/nodes/{node_id}/artifacts/{artifact_name}:read][%d] readArtifactOK  %+v", 200, o.Payload)
}
...
func (o *ReadArtifactOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(run_model.V1ReadArtifactResponse)
...
func (o *ReadArtifactDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v1/runs/{run_id}/nodes/{node_id}/artifacts/{artifact_name}:read][%d] ReadArtifact default  %+v", o._statusCode, o.Payload)
}
