...
// WithResourceReferenceKeyID adds the resourceReferenceKeyID to the run service list runs params
func (o *RunServiceListRunsParams) WithResourceReferenceKeyID(resourceReferenceKeyID *string) *RunServiceListRunsParams {
	o.SetResourceReferenceKeyID(resourceReferenceKeyID)
	return o
}

// SetResourceReferenceKeyID adds the resourceReferenceKeyId to the run service list runs params
func (o *RunServiceListRunsParams) SetResourceReferenceKeyID(resourceReferenceKeyID *string) {
	o.ResourceReferenceKeyID = resourceReferenceKeyID
}

// WithResourceReferenceKeyType adds the resourceReferenceKeyType to the run service list runs params
func (o *RunServiceListRunsParams) WithResourceReferenceKeyType(resourceReferenceKeyType *string) *RunServiceListRunsParams {
	o.SetResourceReferenceKeyType(resourceReferenceKeyType)
	return o
}

// SetResourceReferenceKeyType adds the resourceReferenceKeyType to the run service list runs params
func (o *RunServiceListRunsParams) SetResourceReferenceKeyType(resourceReferenceKeyType *string) {
