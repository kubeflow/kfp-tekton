...
func (o *UploadPipelineVersionOK) GetPayload() *pipeline_upload_model.V1PipelineVersion {
	return o.Payload
}
...
func (o *UploadPipelineVersionDefault) GetPayload() *pipeline_upload_model.V1Status {
	return o.Payload
}
