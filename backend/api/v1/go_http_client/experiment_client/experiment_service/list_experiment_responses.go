...
func (o *ListExperimentOK) Error() string {
	return fmt.Sprintf("[GET /apis/v1/experiments][%d] listExperimentOK  %+v", 200, o.Payload)
}
...
func (o *ListExperimentDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v1/experiments][%d] ListExperiment default  %+v", o._statusCode, o.Payload)
}
