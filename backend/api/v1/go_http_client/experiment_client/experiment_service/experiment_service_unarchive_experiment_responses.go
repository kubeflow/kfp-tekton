...
func (o *ExperimentServiceUnarchiveExperimentOK) Error() string {
	return fmt.Sprintf("[POST /apis/v1/experiments/{id}:unarchive][%d] experimentServiceUnarchiveExperimentOK  %+v", 200, o.Payload)
}
...
func (o *ExperimentServiceUnarchiveExperimentDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v1/experiments/{id}:unarchive][%d] ExperimentService_UnarchiveExperiment default  %+v", o._statusCode, o.Payload)
}
