...
func (o *ExperimentServiceGetExperimentOK) Error() string {
	return fmt.Sprintf("[GET /apis/v1/experiments/{id}][%d] experimentServiceGetExperimentOK  %+v", 200, o.Payload)
}
...
func (o *ExperimentServiceGetExperimentOK) GetPayload() *experiment_model.V1Experiment {
	return o.Payload
}
...
func (o *ExperimentServiceGetExperimentDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v1/experiments/{id}][%d] ExperimentService_GetExperiment default  %+v", o._statusCode, o.Payload)
}
