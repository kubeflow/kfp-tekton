...
// WithID adds the id to the experiment service get experiment params
func (o *ExperimentServiceGetExperimentParams) WithID(id string) *ExperimentServiceGetExperimentParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the experiment service get experiment params
func (o *ExperimentServiceGetExperimentParams) SetID(id string) {
	o.ID = id
}
