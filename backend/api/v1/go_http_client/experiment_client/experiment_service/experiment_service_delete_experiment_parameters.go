...
// WithID adds the id to the experiment service delete experiment params
func (o *ExperimentServiceDeleteExperimentParams) WithID(id string) *ExperimentServiceDeleteExperimentParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the experiment service delete experiment params
func (o *ExperimentServiceDeleteExperimentParams) SetID(id string) {
	o.ID = id
}
