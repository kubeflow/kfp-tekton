...
type CreateExperimentParams struct {
	...
	*/
	Body *experiment_model.V1Experiment
...
func (o *CreateExperimentParams) WithBody(body *experiment_model.V1Experiment) *CreateExperimentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create experiment params
func (o *CreateExperimentParams) SetBody(body *experiment_model.V1Experiment) {
	o.Body = body
}
