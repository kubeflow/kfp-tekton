...
// WithID adds the id to the experiment service unarchive experiment params
func (o *ExperimentServiceUnarchiveExperimentParams) WithID(id string) *ExperimentServiceUnarchiveExperimentParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the experiment service unarchive experiment params
func (o *ExperimentServiceUnarchiveExperimentParams) SetID(id string) {
	o.ID = id
}
