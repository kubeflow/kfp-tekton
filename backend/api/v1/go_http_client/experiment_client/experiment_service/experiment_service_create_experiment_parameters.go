...
type ExperimentServiceCreateExperimentParams struct {
	...
	*/
	Experiment *experiment_model.V1Experiment
...
func (o *ExperimentServiceCreateExperimentParams) WithExperiment(experiment *experiment_model.V1Experiment) *ExperimentServiceCreateExperimentParams {
	o.SetExperiment(experiment)
	return o
}

// SetExperiment adds the experiment to the experiment service create experiment params
func (o *ExperimentServiceCreateExperimentParams) SetExperiment(experiment *experiment_model.V1Experiment) {
