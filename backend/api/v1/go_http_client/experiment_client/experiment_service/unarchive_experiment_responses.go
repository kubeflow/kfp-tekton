...
import (
	...
	experiment_model "github.com/kubeflow/pipelines/backend/api/v1/go_http_client/experiment_model"
)
...
func (o *UnarchiveExperimentOK) Error() string {
	return fmt.Sprintf("[POST /apis/v1/experiments/{id}:unarchive][%d] unarchiveExperimentOK  %+v", 200, o.Payload)
}
...
type UnarchiveExperimentDefault struct {
	...
	Payload *experiment_model.V1Status
}
...
func (o *UnarchiveExperimentDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v1/experiments/{id}:unarchive][%d] UnarchiveExperiment default  %+v", o._statusCode, o.Payload)
}
...
func (o *UnarchiveExperimentDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(experiment_model.V1Status)
