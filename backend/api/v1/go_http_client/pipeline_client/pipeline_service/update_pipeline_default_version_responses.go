...
func (o *UpdatePipelineDefaultVersionOK) Error() string {
	return fmt.Sprintf("[POST /apis/v1/pipelines/{pipeline_id}/default_version/{version_id}][%d] updatePipelineDefaultVersionOK  %+v", 200, o.Payload)
}
...
func (o *UpdatePipelineDefaultVersionDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v1/pipelines/{pipeline_id}/default_version/{version_id}][%d] UpdatePipelineDefaultVersion default  %+v", o._statusCode, o.Payload)
}
