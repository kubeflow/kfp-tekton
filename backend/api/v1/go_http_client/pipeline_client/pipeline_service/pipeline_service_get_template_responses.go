...
func (o *PipelineServiceGetTemplateOK) Error() string {
	return fmt.Sprintf("[GET /apis/v1/pipelines/{id}/templates][%d] pipelineServiceGetTemplateOK  %+v", 200, o.Payload)
}
...
func (o *PipelineServiceGetTemplateOK) GetPayload() *pipeline_model.V1GetTemplateResponse {
	return o.Payload
}
...
func (o *PipelineServiceGetTemplateDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v1/pipelines/{id}/templates][%d] PipelineService_GetTemplate default  %+v", o._statusCode, o.Payload)
}
