...
func (o *CreatePipelineVersionParams) WithBody(body *pipeline_model.V1PipelineVersion) *CreatePipelineVersionParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create pipeline version params
func (o *CreatePipelineVersionParams) SetBody(body *pipeline_model.V1PipelineVersion) {
	o.Body = body
}
