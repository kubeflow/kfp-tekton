...
type CreatePipelineParams struct {
	...
	/*Body*/
	Body *pipeline_model.V1Pipeline
...
func (o *CreatePipelineParams) WithBody(body *pipeline_model.V1Pipeline) *CreatePipelineParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create pipeline params
func (o *CreatePipelineParams) SetBody(body *pipeline_model.V1Pipeline) {
	o.Body = body
}
