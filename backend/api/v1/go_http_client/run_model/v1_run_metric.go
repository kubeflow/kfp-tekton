...
// V1RunMetric v1 run metric
//
// swagger:model v1RunMetric
type V1RunMetric struct {
...
func (m *V1RunMetric) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RunMetric) validateFormat(formats strfmt.Registry) error {
...
// ContextValidate validate this v1 run metric based on the context it is used
func (m *V1RunMetric) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1RunMetric) contextValidateFormat(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1RunMetric) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RunMetric) UnmarshalBinary(b []byte) error {
	var res V1RunMetric
