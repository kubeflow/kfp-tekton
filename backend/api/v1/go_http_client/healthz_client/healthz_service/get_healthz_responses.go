...
import (
	...
	healthz_model "github.com/kubeflow/pipelines/backend/api/v1/go_http_client/healthz_model"
)
...
type GetHealthzDefault struct {
	...
	Payload *healthz_model.V1Status
}
...
func (o *GetHealthzDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(healthz_model.V1Status)
