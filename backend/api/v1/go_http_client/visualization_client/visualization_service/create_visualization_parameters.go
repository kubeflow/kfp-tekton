...
type CreateVisualizationParams struct {
	...
	/*Body*/
	Body *visualization_model.V1Visualization
	/*Namespace*/
	Namespace string
...
func (o *CreateVisualizationParams) WithBody(body *visualization_model.V1Visualization) *CreateVisualizationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create visualization params
func (o *CreateVisualizationParams) SetBody(body *visualization_model.V1Visualization) {
	o.Body = body
}
