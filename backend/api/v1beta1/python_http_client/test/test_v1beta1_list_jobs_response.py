...
from kfp_server_api_v1beta1.models.v1beta1_list_jobs_response import V1beta1ListJobsResponse  # noqa: E501
from kfp_server_api_v1beta1.rest import ApiException

class TestV1beta1ListJobsResponse(unittest.TestCase):
    """V1beta1ListJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1beta1ListJobsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kfp_server_api_v1beta1.models.v1beta1_list_jobs_response.V1beta1ListJobsResponse()  # noqa: E501
        if include_optional :
            return V1beta1ListJobsResponse(
                jobs = [
                    kfp_server_api_v1beta1.models.v1beta1_job.v1beta1Job(
                        id = '0', 
                        name = '0', 
                        description = '0', 
                        pipeline_spec = kfp_server_api_v1beta1.models.v1beta1_pipeline_spec.v1beta1PipelineSpec(
                            ...
                            runtime_config = kfp_server_api_v1beta1.models.pipeline_spec_runtime_config.PipelineSpecRuntimeConfig(
                                parameters = {
                                    'key' : kfp_server_api_v1beta1.models.v1beta1_value.v1beta1Value(
                                        int_value = '0', 
                                        double_value = 1.337, 
                                        string_value = '0', )
                                    }, 
    ...
    def testV1beta1ListJobsResponse(self):
        """Test V1beta1ListJobsResponse"""
