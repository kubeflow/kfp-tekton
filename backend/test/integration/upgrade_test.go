...
func (s *UpgradeTests) PrepareExperiments() {
	...
	experiment := &experiment_model.V1beta1Experiment{Name: "training", Description: "my first experiment"}
	...
	experiment = &experiment_model.V1beta1Experiment{Name: "prediction", Description: "my second experiment"}
	_, err = s.experimentClient.Create(&experimentParams.CreateExperimentParams{
		Body: experiment,
	})
	require.Nil(t, err)
	...
	time.Sleep(1 * time.Second)
	experiment = &experiment_model.V1beta1Experiment{Name: "moonshot", Description: "my third experiment"}
	_, err = s.experimentClient.Create(&experimentParams.CreateExperimentParams{
		Body: experiment,
	})
	require.Nil(t, err)
