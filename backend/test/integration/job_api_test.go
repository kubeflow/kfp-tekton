...
func (s *JobApiTestSuite) TestJobApis() {
	...
	experiment = &experiment_model.V1beta1Experiment{Name: "argument parameter experiment"}
...
func (s *JobApiTestSuite) TestJobApis_noCatchupOption() {
	...
	experiment := &experiment_model.V1beta1Experiment{Name: "periodic catchup true"}
	...
	experiment = &experiment_model.V1beta1Experiment{Name: "periodic catchup false"}
	...
	experiment = &experiment_model.V1beta1Experiment{Name: "cron catchup true"}
	...
	experiment = &experiment_model.V1beta1Experiment{Name: "cron catchup false"}
