...
import (
	...
	"github.com/kubeflow/pipelines/backend/src/v2/tekton-exithandler/client/clientset/versioned/scheme"
...
func (c *CustomV1alpha1Client) ExitHandlers(namespace string) ExitHandlerInterface {
	return newExitHandlers(c, namespace)
}
