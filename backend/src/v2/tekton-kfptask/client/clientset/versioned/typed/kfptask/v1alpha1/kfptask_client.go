...
import (
	...
	"github.com/kubeflow/pipelines/backend/src/v2/tekton-kfptask/client/clientset/versioned/scheme"
...
func (c *CustomV1alpha1Client) KfpTasks(namespace string) KfpTaskInterface {
	return newKfpTasks(c, namespace)
}
