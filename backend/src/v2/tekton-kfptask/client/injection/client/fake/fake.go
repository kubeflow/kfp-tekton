...
import (
	...
	fake "github.com/kubeflow/pipelines/backend/src/v2/tekton-kfptask/client/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/kubeflow/pipelines/backend/src/v2/tekton-kfptask/client/clientset/versioned/fake.Clientset from context.")
	}
