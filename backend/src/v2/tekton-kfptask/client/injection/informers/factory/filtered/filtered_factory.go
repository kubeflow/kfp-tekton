...
import (
	...
	externalversions "github.com/kubeflow/pipelines/backend/src/v2/tekton-kfptask/client/informers/externalversions"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/kubeflow/pipelines/backend/src/v2/tekton-kfptask/client/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
