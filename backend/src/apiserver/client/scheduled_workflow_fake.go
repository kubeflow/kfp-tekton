...
func (c *FakeScheduledWorkflowClient) Create(ctx context.Context, scheduledWorkflow *v1beta1.ScheduledWorkflow, options v1.CreateOptions) (*v1beta1.ScheduledWorkflow, error) {
...
func (c *FakeScheduledWorkflowClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions,
	subresources ...string) (result *v1beta1.ScheduledWorkflow, err error) {
	return nil, nil
}
...
func (c *FakeScheduledWorkflowClient) Update(ctx context.Context, workflow *v1beta1.ScheduledWorkflow, options v1.UpdateOptions) (*v1beta1.ScheduledWorkflow, error) {
...
func (FakeBadScheduledWorkflowClient) Create(ctx context.Context, workflow *v1beta1.ScheduledWorkflow, options v1.CreateOptions) (*v1beta1.ScheduledWorkflow, error) {
...
func (FakeBadScheduledWorkflowClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions,
	subresources ...string) (result *v1beta1.ScheduledWorkflow, err error) {
	return nil, errors.New("some error")
}
