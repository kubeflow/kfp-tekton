 ...
 *
 * @export
 * @interface V1PipelineRuntime
 */
export interface V1PipelineRuntime {
  /**
 ...
 *
 * @export
 * @interface V1ReadArtifactResponse
 */
export interface V1ReadArtifactResponse {
  /**
   * The bytes of the artifact content.
   * @type {string}
   * @memberof V1ReadArtifactResponse
   */
  data?: string;
}
 ...
 *
 * @export
 * @interface V1ReportRunMetricsRequest
 */
export interface V1ReportRunMetricsRequest {
  /**
   * Required. The parent run ID of the metric.
   * @type {string}
   * @memberof V1ReportRunMetricsRequest
   */
  run_id?: string;
  /**
   * List of metrics to report.
   * @type {Array<V1RunMetric>}
   * @memberof V1ReportRunMetricsRequest
   */
  metrics?: Array<V1RunMetric>;
}

/**
 *
 * @export
 * @interface V1ReportRunMetricsResponse
 */
export interface V1ReportRunMetricsResponse {
  /**
   *
   * @type {Array<ReportRunMetricsResponseReportRunMetricResult>}
   * @memberof V1ReportRunMetricsResponse
   */
...
export interface V1Run {
   ...
   * @type {V1RunStorageState}
   * @memberof V1Run
   */
  storage_state?: V1RunStorageState;
  /**
   *
   * @type {string}
   * @memberof V1Run
 ...
 *
 * @export
 * @interface V1RunDetail
 */
export interface V1RunDetail {
  /**
   *
   * @type {V1Run}
   * @memberof V1RunDetail
   */
  run?: V1Run;
  /**
   *
   * @type {V1PipelineRuntime}
   * @memberof V1RunDetail
   */
 ...
 *
 * @export
 * @interface V1RunMetric
 */
export interface V1RunMetric {
  /**
...
export const RunServiceApiFetchParamCreator = function(configuration?: Configuration) {
  return {
    ...
    archiveRun(id: string, options: any = {}): FetchArgs {
      ...
      const localVarPath = `/apis/v1/runs/{id}:archive`.replace(
        `{${'id'}}`,
     ...
     * @throws {RequiredError}
     */
    createRun(body: V1Run, options: any = {}): FetchArgs {
      ...
      const localVarPath = `/apis/v1/runs`;
      const localVarUrlObj = url.parse(localVarPath, true);
      const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
      const localVarHeaderParameter = {} as any;
      const localVarQueryParameter = {} as any;
    ...
    deleteRun(id: string, options: any = {}): FetchArgs {
      ...
      const localVarPath = `/apis/v1/runs/{id}`.replace(
        `{${'id'}}`,
        encodeURIComponent(String(id)),
      );
      const localVarUrlObj = url.parse(localVarPath, true);
    ...
    getRun(run_id: string, options: any = {}): FetchArgs {
      ...
      const localVarPath = `/apis/v1/runs/{run_id}`.replace(
        `{${'run_id'}}`,
    ...
    readArtifact(
      ...
      const localVarPath = `/apis/v1/runs/{run_id}/nodes/{node_id}/artifacts/{artifact_name}:read`
     ...
     * @param {V1ReportRunMetricsRequest} body
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    reportRunMetrics(
      run_id: string,
      body: V1ReportRunMetricsRequest,
      options: any = {},
    ): FetchArgs {
      // verify required parameter 'run_id' is not null or undefined
      if (run_id === null || run_id === undefined) {
      ...
      const localVarPath = `/apis/v1/runs/{run_id}:reportMetrics`.replace(
        `{${'run_id'}}`,
        encodeURIComponent(String(run_id)),
      );
      const localVarUrlObj = url.parse(localVarPath, true);
      ...
      localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
      const needsSerialization =
        <any>'V1ReportRunMetricsRequest' !== 'string' ||
        localVarRequestOptions.headers['Content-Type'] === 'application/json';
      localVarRequestOptions.body = needsSerialization ? JSON.stringify(body || {}) : body || '';
    ...
    retryRun(run_id: string, options: any = {}): FetchArgs {
      ...
      const localVarPath = `/apis/v1/runs/{run_id}/retry`.replace(
        `{${'run_id'}}`,
        encodeURIComponent(String(run_id)),
      );
      const localVarUrlObj = url.parse(localVarPath, true);
    ...
    terminateRun(run_id: string, options: any = {}): FetchArgs {
      ...
      const localVarPath = `/apis/v1/runs/{run_id}/terminate`.replace(
        `{${'run_id'}}`,
        encodeURIComponent(String(run_id)),
      );
      const localVarUrlObj = url.parse(localVarPath, true);
    ...
    unarchiveRun(id: string, options: any = {}): FetchArgs {
      ...
      const localVarPath = `/apis/v1/runs/{id}:unarchive`.replace(
        `{${'id'}}`,
        encodeURIComponent(String(id)),
      );
      const localVarUrlObj = url.parse(localVarPath, true);
...
export const RunServiceApiFp = function(configuration?: Configuration) {
  return {
    ...
    createRun(
      body: V1Run,
      options?: any,
    ): (fetch?: FetchAPI, basePath?: string) => Promise<V1RunDetail> {
    ...
    listRuns(
      ...
      filter?: string,
      options?: any,
    ): (fetch?: FetchAPI, basePath?: string) => Promise<V1ListRunsResponse> {
    ...
    readArtifact(
      ...
      artifact_name: string,
      options?: any,
    ): (fetch?: FetchAPI, basePath?: string) => Promise<V1ReadArtifactResponse> {
    ...
    reportRunMetrics(
      ...
      body: V1ReportRunMetricsRequest,
      options?: any,
    ): (fetch?: FetchAPI, basePath?: string) => Promise<V1ReportRunMetricsResponse> {
...
export const RunServiceApiFactory = function(
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createRun(body: V1Run, options?: any) {
     ...
     * @throws {RequiredError}
     */
    reportRunMetrics(run_id: string, body: V1ReportRunMetricsRequest, options?: any) {
...
export class RunServiceApi extends BaseAPI {
   ...
   * @memberof RunServiceApi
   */
  public createRun(body: V1Run, options?: any) {
   ...
   * @memberof RunServiceApi
   */
  public reportRunMetrics(run_id: string, body: V1ReportRunMetricsRequest, options?: any) {
