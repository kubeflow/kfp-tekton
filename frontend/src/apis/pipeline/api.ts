 ...
 *
 * @export
 * @interface V1ListPipelineVersionsResponse
 */
export interface V1ListPipelineVersionsResponse {
  /**
   *
   * @type {Array<V1PipelineVersion>}
   * @memberof V1ListPipelineVersionsResponse
   */
  versions?: Array<V1PipelineVersion>;
  /**
 ...
 *
 * @export
 * @interface V1ListPipelinesResponse
 */
export interface V1ListPipelinesResponse {
  /**
   *
   * @type {Array<V1Pipeline>}
   * @memberof V1ListPipelinesResponse
   */
 ...
 *
 * @export
 * @interface V1PipelineVersion
 */
export interface V1PipelineVersion {
  /**
   * Output. Unique version ID. Generated by API server.
   * @type {string}
   * @memberof V1PipelineVersion
   */
  id?: string;
  /**
...
export const PipelineServiceApiFetchParamCreator = function(configuration?: Configuration) {
  return {
     ...
     * @param {V1Pipeline} body
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    createPipeline(body: V1Pipeline, options: any = {}): FetchArgs {
      ...
      const localVarPath = `/apis/v1/pipelines`;
     ...
     * @param {V1PipelineVersion} body ResourceReference inside PipelineVersion specifies the pipeline that this version belongs to.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    createPipelineVersion(body: V1PipelineVersion, options: any = {}): FetchArgs {
      // verify required parameter 'body' is not null or undefined
      if (body === null || body === undefined) {
        throw new RequiredError(
          'body',
      ...
      const localVarPath = `/apis/v1/pipeline_versions`;
      const localVarUrlObj = url.parse(localVarPath, true);
      const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
      const localVarHeaderParameter = {} as any;
      const localVarQueryParameter = {} as any;
    ...
    deletePipeline(id: string, options: any = {}): FetchArgs {
      ...
      const localVarPath = `/apis/v1/pipelines/{id}`.replace(
        `{${'id'}}`,
    ...
    deletePipelineVersion(version_id: string, options: any = {}): FetchArgs {
      ...
      const localVarPath = `/apis/v1/pipeline_versions/{version_id}`.replace(
        `{${'version_id'}}`,
    ...
    getPipelineVersionTemplate(version_id: string, options: any = {}): FetchArgs {
      ...
      const localVarPath = `/apis/v1/pipeline_versions/{version_id}/templates`.replace(
        `{${'version_id'}}`,
        encodeURIComponent(String(version_id)),
      );
      const localVarUrlObj = url.parse(localVarPath, true);
    ...
    getTemplate(id: string, options: any = {}): FetchArgs {
      ...
      const localVarPath = `/apis/v1/pipelines/{id}/templates`.replace(
        `{${'id'}}`,
        encodeURIComponent(String(id)),
      );
      const localVarUrlObj = url.parse(localVarPath, true);
    ...
    updatePipelineDefaultVersion(
      ...
      const localVarPath = `/apis/v1/pipelines/{pipeline_id}/default_version/{version_id}`
...
export const PipelineServiceApiFp = function(configuration?: Configuration) {
  return {
    ...
    createPipeline(
      body: V1Pipeline,
      options?: any,
    ): (fetch?: FetchAPI, basePath?: string) => Promise<V1Pipeline> {
    ...
    createPipelineVersion(
      body: V1PipelineVersion,
      options?: any,
    ): (fetch?: FetchAPI, basePath?: string) => Promise<V1PipelineVersion> {
    ...
    getPipelineVersionTemplate(
      version_id: string,
      options?: any,
    ): (fetch?: FetchAPI, basePath?: string) => Promise<V1GetTemplateResponse> {
      const localVarFetchArgs = PipelineServiceApiFetchParamCreator(
        configuration,
    ...
    listPipelineVersions(
      ...
      filter?: string,
      options?: any,
    ): (fetch?: FetchAPI, basePath?: string) => Promise<V1ListPipelineVersionsResponse> {
      const localVarFetchArgs = PipelineServiceApiFetchParamCreator(
        configuration,
      ).listPipelineVersions(
        resource_key_type,
    ...
    listPipelines(
      ...
      resource_reference_key_id?: string,
      options?: any,
    ): (fetch?: FetchAPI, basePath?: string) => Promise<V1ListPipelinesResponse> {
...
export const PipelineServiceApiFactory = function(
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createPipeline(body: V1Pipeline, options?: any) {
     ...
     * @throws {RequiredError}
     */
    createPipelineVersion(body: V1PipelineVersion, options?: any) {
...
export class PipelineServiceApi extends BaseAPI {
   ...
   */
  public createPipeline(body: V1Pipeline, options?: any) {
   ...
   * @memberof PipelineServiceApi
   */
  public createPipelineVersion(body: V1PipelineVersion, options?: any) {
